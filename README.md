...
## 🚀 Live Demo
👉 **[ai-language-translator-crd3s3hykkbdu6wec2o6qj.streamlit.app](https://ai-language-translator-crd3s3hykkbdu6wec2o6qj.streamlit.app/)**
...
```bash
git clone https://github.com/Swapnil-bo/AI-Language-Translator.git
